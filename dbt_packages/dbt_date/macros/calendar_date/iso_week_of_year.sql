...
{%- macro gaussdbdws__iso_week_of_year(date) -%}
-- gaussdbdws week is isoweek, the first week of a year containing January 4 of that year.
{{ dbt_date._iso_week_of_year(date, 'week') }}
{%- endmacro %}

{%- macro duckdb__iso_week_of_year(date) -%}
{{ return(dbt_date.gaussdbdws__iso_week_of_year(date)) }}
{%- endmacro %}
